...
Public Class CRoles
    'Represents the ROLE table and its sasociated buisness rules
    ...
    Public ReadOnly Property CurrentObject() As CRole
        'exposes the CRole object to the GUI later
        Get
            Return _Role
        End Get
    End Property
    ...
    Public Sub CreateNewRole()
        'call this when clearing the edit portion of the screen to add new role
        Clear()
